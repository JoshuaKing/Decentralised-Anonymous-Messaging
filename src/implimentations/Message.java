...
public class Message implements IMessage {
	...
	private Message(PublicKey key, AsymmetricEncryptionType aet, LinkedHashMap<String, String> message) throws UnsupportedOperationException, InvalidParameterException {
	...
	public static Message createNew(PublicKey key, AsymmetricEncryptionType aet, LinkedHashMap<String, String> message) throws UnsupportedOperationException, InvalidParameterException {
		return new Message(key, aet, message);
	}
